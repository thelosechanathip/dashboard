...
class DashboardController extends Controller
{
    ...
    public function test(Request $request) {
        ...
        return view('test', compact('data', 'ovst_count', 'er_regist_count', 'refer_out_count', 'refer_in_count', 'ipt_count'));
    }
    ...
    public function setting(Request $request) {
        ...
        return view('setting', compact('data', 'ovst_count', 'er_regist_count', 'refer_out_count', 'refer_in_count', 'ipt_count'));
    }
}
