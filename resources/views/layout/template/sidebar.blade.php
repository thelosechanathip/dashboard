<nav id="sidebar" class="bg-light sidebar shadow-lg">
    <div class="position-sticky py-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link dropdown-toggle text-dark" href="#" data-bs-toggle="collapse" data-bs-target="#menu1" aria-expanded="{{ request()->routeIs('route1', 'route2') ? 'true' : 'false' }}" aria-controls="menu1">
            ...
            <li class="nav-item">
                ...
                <div class="collapse ms-5 {{ request()->routeIs('report_index_authen_code') ? 'show' : '' }}" id="menu2">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li class="mb-1 sub-menu-custom"><a href="{{ route('report_index_authen_code') }}" class="link-dark rounded text-decoration-none {{ request()->routeIs('report_index_authen_code') ? 'active text-success fw-bold' : 'text-dark' }}">การขอเลข Authen Code</a></li>
                    </ul>
                </div>
            </li>
        </ul>
