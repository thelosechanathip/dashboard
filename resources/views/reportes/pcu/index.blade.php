                ...
                <div class="container p-2 mt-3">
                    ...
                    <table id="table-fetch-list" class="table table-hover table-bordered table-striped align-middle dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            <tr><td><a href="{{ route('report_patients_utilizing_icd10_codes_index', ['id' => $sidebar_sub1_menu_id]) }}" class="link-dark fw-bold text-decoration-none fs-5 link_hover">รายงานรายชื่อคนไข้ที่มารับบริการด้วย ICD10</a></td></tr>
