...
@section('title')
    <title>รายชื่อคนไข้ตรวจ FBS อายุ 35-59 (ไม่รวม ICD E10-E14)</title>
@endsection

@section('content')
    <main class="main-content mb-5" id="fbs_main">
        {{-- Title แสดงข้อมูล ชื่อผู้ใช้งาน และ แผนก Start --}}
            <div class="card shadow-lg full-width-bar p-3" data-aos="fade-left" data-aos-easing="linear" data-aos-duration="400">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center mt-3">
                    <div class="d-flex">
                        <h1 class="h2">รายชื่อคนไข้ตรวจ FBS อายุ 35-59 (ไม่รวม ICD E10-E14)</h1>
                    </div>
                </div>
            </div>
        ...
        {{-- All Form Date End --}}
        {{-- Show Table Start --}}
            <div class="mt-3 card shadow-lg w-100" id="report_fbs_table">
                <div class="mx-5 w-auto">
                    <div class="my-5 ms-0 w-auto">
                        <div class="w-auto" id="fetch-report-fbs"></div>
                    </div>
                </div>
            </div>
        {{-- Show Table End --}}
        ...
        $(document).ready(function() {
            ...
            // เริ่มต้น Hide Start
                ...
                function hideAll() {
                    ...
                    $('#report_fbs_table').hide(); // ปิดการมองเห็นของ Card ที่เก็บ Table ที่ดึงข้อมูลมาแสดงบนหน้า HTML
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if(response.status === 400) {
                                ...
                                $('#report_fbs_table').show();
                                $("#fetch-report-fbs").html(response);
                                $("#table-fetch-report-fbs").DataTable({
                                    responsive: true,
                                    order: [0, 'desc'],
                                    autoWidth: false,
                                    fixedHeader: true,
