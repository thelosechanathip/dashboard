...
@section('title')
    <title>ทะเบียนคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลัน</title>
@endsection

@section('content')
    <!-- Modal เยี่ยมบ้าน รพ.ครั้ง Start -->
        {{-- ทะเบียนเยี่ยมบ้าน  Z718 Start --}}
            <div class="modal fade " id="acs_home_visiting_information_z718" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-custom modal-dialog-centered mt-5">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="acs_home_visiting_information_z718_title">ข้อมูลการเยี่ยมบ้าน Family Meeting</h5>
                            <button type="button" class="btn-close zoom-card" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="container" id="show-acs-home-visiting-information-z718"></div>
                        </div>
        ...
        {{-- ทะเบียนเยี่ยมบ้าน รพ.(ครั้ง) Start --}}
            <div class="modal fade " id="acs_home_visiting_information" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-custom modal-dialog-centered mt-5">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="acs_home_visiting_information_title">ข้อมูลการเยี่ยมบ้าน</h5>
                            <button type="button" class="btn-close zoom-card" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="container" id="show-acs-home-visiting-information"></div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger zoom-card" data-bs-dismiss="modal">Close</button>
                        </div>
    ...
    <main class="main-content mb-5" id="main">
        {{-- Title แสดงข้อมูล ชื่อผู้ใช้งาน และ แผนก Start --}}
            <div class="card shadow-lg full-width-bar p-3" data-aos="fade-left" data-aos-easing="linear" data-aos-duration="400">
                <div
                    ...
                    <div class="d-flex">
                        <h1 class="h2">ทะเบียนคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลัน</h1>
                    </div>
                </div>
            </div>
                        ...
                        <form id="selectForm" class="me-3">
                            ...
                            <div class="mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-2 me-2" id="select" aria-label="Default select example"
                                    ...
                                    <option value="1">ดูจำนวนผู้ป่วยภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลันแยกตาม รพสต.</option>
                                    <option value="2">ดูรายชื่อผู้ป่วยภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลัน</option>
                                </select>
                            </div>
                        </form>
            ...
            <div class="mt-3 card shadow-lg full-width-bar p-3" id="form_all">
                <div class="row mt-3">
                    <div class="d-flex align-items-center justify-content-between">
                        {{-- Form ดึงจำนวนคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลันแยกตาม รพสต. Start --}}
                            <form id="acs_count_shph_form" class="text-start">
                                @csrf
                                <div class="mb-3 d-flex align-items-center row">
                                    ...
                                    <div class="col d-flex align-items-center">
                                        <button type="button" id="acs_count_shph_submit" class="btn btn-primary ms-3 zoom-card">ยืนยัน</button>
                                    </div>
                                </div>
                            </form>
                        {{-- Form ดึงจำนวนคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลันแยกตาม รพสต. End --}}
                        {{-- Form ดึงรายชื่อคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลัน Start --}}
                            <form id="acs_list_name_form">
                                @csrf
                                <div class="mb-3 d-flex align-items-center row">
                                    <div class="col d-flex align-items-center">
                                        <div class="" style="min-width: 80px;">
                                    ...
                                    <div class="col d-flex align-items-center">
                                        <button type="button" id="acs_list_name_submit" class="btn btn-primary ms-1 zoom-card">ยืนยัน</button>
                                    </div>
                                </div>
                            </form>
                        {{-- Form ดึงรายชื่อคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลัน End --}}
                    </div>
                </div>
            </div>
        {{-- All Form Date End --}}

        {{-- แสดงข้อมูลคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลันแยกตาม รพสต. แบบ Chart Start --}}
            <div class="mt-3 card shadow-lg w-auto" id="acs_count_shph_all_chart">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="container">
                            <div class="my-5">
                                <canvas id="acs_my_chart" width="300" height="100"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
        {{-- แสดงข้อมูลคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลันแยกตาม รพสต. แบบ Chart End --}}
        {{-- แสดงข้อมูลคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลัน ตาม วันที่, สถานบริการ, สถานการมีชีวิตหรือเสียชีวิต แบบ Table Start --}}
            <div class="mt-3 card shadow-lg w-100" id="acs_list_name_table">
                <div class="row w-100">
        ...
        {{-- แสดงข้อมูลคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลัน ตาม วันที่, สถานบริการ, สถานการมีชีวิตหรือเสียชีวิต แบบ Table End --}}
    </main>
@endsection
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            // เริ่มต้น Hide Start
                $('#acs_count_shph_all_chart').hide();
                $('#acs_count_shph_form').hide();
                $('#acs_list_name_form').hide();
                $('#acs_list_name_table').hide();
                $('.loadingIcon').hide();
                $('#form_all').hide();
            // เริ่มต้น Hide End
            ...
            // จาก form ID "select" เลือกแบบ Realtime Start
                $('#select').change(function() {
                    ...
                    if (selectForm != '0' && selectForm == '1') { // 1 = จำนวนผู้ป่วยภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลันแยกตาม รพสต.
                        $('#acs_count_shph_form').show();
                        $('#form_all').show();
                        $('#acs_list_name_form').hide();
                        $('#acs_list_name_table').hide();
                    } else if (selectForm != '0' && selectForm == '2') { // 2 = รายชื่อผู้ป่วยภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลัน
                        $('#acs_list_name_form').show();
                        $('#form_all').show();
                        $('#acs_count_shph_form').hide();
                        $('#acs_count_shph_all_chart').hide();
                    } else {
                        ...
                        $('.loadingIcon').hide();
                        $('#form_all').hide();
                        $("#acs_list_name_form")[0].reset();
                        $("#acs_count_shph_form")[0].reset();
                    }
                });
            ...
            // Set Text Start
                function setText(request) {
                    if(request == 0) {
                        ...
                        $('#setCount').show();
                        $('#setText').text('');
                        $('#setCount').text('ไม่มีคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลัน');
                    } else {
                        $('#setText').show();
                        $('#setCount').show();
                        $('#setText').text('จำนวนคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลันที่แยกตาม รพสต. : ');
            ...
            // ดึงข้อมูลคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลันแยกตาม รพสต. แสดงแบบ Chart Start
                $('#acs_count_shph_submit').click(function(e) {
                    // ป้องกันการ Reload ของหน้าเว็บใหม่
                    e.preventDefault();

                    // ดึงข้อมูลจาก Form ด้วย ID
                    var formData = $('#acs_count_shph_form').serialize();
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if(response.status === 400) {
                                ...
                                $('#acs_count_shph_all_chart').show();
                                $('#acs_list_name_table').hide();
                                // Reset Form ที่มี ID ตามด้านล่าง
                                $("#acs_list_name_form")[0].reset();

                                // นำ Response ที่มี Chart นำไปเก็บไว้ในตัวแปร chart_count_acs_shph
                                var chart_count_acs_shph = response.chart_count_acs_shph;
                                ...
                                var ctx = document.getElementById('acs_my_chart').getContext('2d');
                                chart = new Chart(ctx, {
                                    // แสดง Chart ในรูปแบบกราฟแท่ง
                                    type: 'bar',
                                    // ดึงข้อมูลจาก Response มาแสดง
                                    data: chart_count_acs_shph,
                                    // ดึงข้อมูลจาก Response ในส่วนของ Options มาแสดง
                                    options: chart_count_acs_shph.options
                                });

                                // ดึงข้อมูลจาก Response มารวมกันเพื่อหาผลรวมของข้อมูล
                                var total = chart_count_acs_shph.datasets[0].data.reduce(function(sum, value) {
                                    return sum + value;
                                }, 0).toLocaleString();
            ...
            // ดึงข้อมูลคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลันแยกตาม รพสต. แสดงแบบ Chart End

            function getACSFetchListName() {
                var formData = $('#acs_list_name_form').serialize();
            ...
            // ดึงข้อมูลรายชื่อคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลัน ตาม วันที่, เวลา, สถานบริการ, สถานะการมีชีวิตหรือเสียชีวิต Start
                $('#acs_list_name_submit').click(function(e) {
                    e.preventDefault();
                    getACSFetchListName();
                });
            // ดึงข้อมูลรายชื่อคนไข้ภาวะกล้ามเนื้อหัวใจขาดเลือดเฉียบพลัน ตาม วันที่, เวลา, สถานบริการ, สถานะการมีชีวิตหรือเสียชีวิต End

            // ดึงข้อมูลการเยี่ยมบ้าน Z718 แสดงบน Modal Start
                $(document).on('click', '.acs-home-visiting-information-z718', function (e) {
                    e.preventDefault();
                    let id = $(this).attr('id');
                    $('#show-acs-home-visiting-information').hide();
                    $('#show-acs-home-visiting-information-z718').hide();
                    $('#setText').hide();
                    $('#setCount').hide();
                    ...
                    $.ajax({
                        url: '{{ route('getACSHomeVisitingInformationZ718') }}',
                        method: 'get',
                        data: {
                            id: id,
                            _token: '{{ csrf_token() }}'
                        ...
                        success: function(response) {
                            Swal.close();
                            $('#show-acs-home-visiting-information-z718').show();
                            $("#show-acs-home-visiting-information-z718").html(response);
                        }
                    });
                });
            ...
            // ดึงข้อมูลการเยี่ยมบ้าน รพ.(ครั้ง) แสดงบน Modal Start
                $(document).on('click', '.acs-home-visiting-information', function (e) {
                    e.preventDefault();
                    let id = $(this).attr('id');
                    $('#show-acs-home-visiting-information').hide();
                    $('#show-acs-home-visiting-information-z718').hide();
                    ...
                    $.ajax({
                        url: '{{ route('getACSHomeVisitingInformation') }}',
                        method: 'get',
                        data: {
                            id: id,
                            _token: '{{ csrf_token() }}'
                        ...
                        success: function(response) {
                            Swal.close();
                            $('#show-acs-home-visiting-information').show();
                            $("#show-acs-home-visiting-information").html(response);
                        }
                    });
                });
